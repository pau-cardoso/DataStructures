/**
 * @file bst.hpp
 * @brief Implementacion de la clase BST
 * @authors 
...
/**
 *  Metodo: imprimirInOrder
 *  Descripcion: Imprime el arbol a partir de un nodo dado 
 *               con un recorrido InOrder. @param actual Nodo 
 *               a partir del cual se quiere imprimir el resto 
 *               del arbol
 *  Complejidad O(n)
*/
template <typename T>
...
/**
 *  Metodo: imprimirPreOrder
 *  Descripcion: Imprime el arbol a partir de un nodo dado 
 *               con un recorrido PreOrder. @param actual 
 *               Nodo a partir del cual se quiere imprimir 
 *               el resto del arbol
 *  Complejidad O(n)
*/
template <typename T>
...
/**
 *  Metoro: imprimirPostOrder
 *  Descripcion: Imprime el arbol a partir de un nodo dado 
 *               con un recorrido PostOrder. @param actual 
 *               Nodo a partir del cual se quiere imprimir 
 *               el resto del arbol
 *  Complejidad O(n)
*/
...
/**
 *  Metodo: imprimirLevelByLevel
 *  Descripcion: Imprime el arbol a partir de un nodo dado
 *               con un recorrido LevelByLevel. @param actual 
 *               Nodo a partir del cual se quiere imprimir el resto 
 *               del arbol
 *  Complejidad O(n)
*/
template <typename T>
...
/**
 *  Metodo: valorMenor
 *  Descripcion: Buscar el nodo menor de un subarbol con 
 *               raiz en el nodo actual
 *  Complejidad: O(n)
*/
template <typename T>
...
/**
 *  Metodo: valorMayor
 *  Descripcion: Buscar el nodo mayor de un subarbol con 
 *               raiz en el nodo actual
 *  Complejidad: O(n)
*/
template <typename T>
...
/**
 *  Metodo: height
 *  Descripcion: Calcula la altura a partir de un nodo dado
 *               @param nodo Nodo del cual se quiere calcular 
 *               la altura @return Un entero que indica la 
 *               altura del nodo dado
 *  Complejidad: O(n)
*/
template <typename T>
...
/**
 * Metodo: agregaNodoIterativo
 * Descripcion: Agrega un nuevo nodo al arbol en la posicion segun 
 *              el valor que se desea agregar @param valor Valor 
...
void BST<T> :: agregaNodoIterativo(T valor) {
    ...
    NodoArbolBinario<T> *nodoRepetido = buscarNodo(valor);
    if (!nodoRepetido) {
        //Árbol con valores
        ...
        Accesos miAcceso = Accesos( nodoRepetido->getValor() );
        miAcceso.addIP(valor.getIP());
    }
}

/**
 * Metodo: buscarNodo
 * Descripcion: Busca el valor dado como parametro en algun nodo del arbol
 *              @param valor Valor a buscar dentro del arbol
 *              @return El nodo con el valor buscado, si no hay valor buscado 
 *              regresa nullptr
 * Complejidad: O(n)
*/
template <typename T>
...
/**
 * Metodo: visit
 * Descripcion: Imprime el arbol segun la opcion que desea 
 *              el usuario. @param opcion Un entero (1-3) 
 *              segun la opcion que desea el usuario@return un 
 *              entero con la altura del arbol o -1 en caso de que 
 *              no haya nodos en el arbol
 * Complejidad: O(n)
*/
template <typename T>
...
/**
 * Metodo: height
 * Descripcion: Regresa la altura del arbol binario completo
 *              @return un entero con la altura del arbol o -1 
 *              en caso de que no haya nodos en el arbol
 * Complejidad: O(n)
*/
template <typename T>
int BST<T> :: height() {
...
/**
 * Metodo: whatLevelAmI
 * Descripcion: Regresará un entero que indica el nivel en que se encuentra un dato, 
 *              o -1 en caso de que no se encuentre en el BST
 *              @param valor Dato a buscar su altura
 *              @return Entero indicando el nivel del dato en el BST, o -1 si no se 
 *              encuentra
 * Complejidad: O(n)
*/
template <typename T>
...
/**
 * Metodo: antecesor
 * Descripcion: Regresa el antecesor de un valor dentro del árbol
...
/**
 * Metodo: eliminarNodo
 * Descripcion: Elimina el nodo del arbol con el valor dado como parametro
...
/**
 * Metodo: imprimirArbolInOrder
 * Descripcion: Imprime el arbol completo de forma InOrder
*/
template <typename T>
void BST<T> :: imprimirArbolInOrder() {
    NodoArbolBinario<T>::imprimirInOrder(root);
    cout << endl;
}

/**
 * Metodo: imprimirArbolPreOrder
 * Descripcion: Imprime el arbol completo de forma PreOrder
*/
template <typename T>
...
/**
 * Metodo: imprimirArbolPostOrder
 * Descripcion: Imprime el arbol completo de forma PostOrder
*/
template <typename T>
...
/**
 * Metodo: imprimirArbolLevelByLevel
 * Descripcion: Imprime el arbol completo de forma LevelByLevel
*/
template <typename T>
